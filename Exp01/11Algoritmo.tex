...
\begin{frame}[fragile]{Algoritmo:}{Iteración 5.}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE 1
  \begin{figure}[ht!]
    \centering
    \begin{tikzpicture}
      ...
      \node(F) [redV, label=180:$F$] at (2.18, 9){};
      \node(G) [redV, label=000:$G$] at (3, 9){};
      \node(H) [redV, label=180:$H$] at (2.18, 8){};
      \node(I) [redV, label=270:$I$] at (3, 8){};
      \node(J) [redV, label=270:$J$] at (4, 8){};
      ...
      %% Tercer bloque:
      \node(T) [yellowV, label=0:$T$] at (8.5,9){};
      \node(Z) [yellowV, label=0:$Z$] at (9,8){};
      \node(V) [yellowV, label=0:$V$] at (8,7){};
      \node(U) [yellowV, label=0:$U$] at (9,6){};
      %% Rectas:
      \draw[edge] (-1,7.3) to (10,7.3); % l_2
      \draw[edge] (-1,10.3) to (10,10.3); % l_1
      % Distancia d:
      \draw[edgeDottedL] (-0.4,7.3) to (-0.4,8.5); % distancia abajo.
      \draw[edgeDottedR] (-0.4,9) to (-0.4,10.3);   % distancia arriba.
      % Nombres:
      \node (*) at (-0.4,8.8){$d$};
      \node (*) at (10.3,7.3){$\ell_2$};
      \node (*) at (10.3,10.3){$\ell_1$};
      ...
      \draw[edgeDotted] (S) to (1,7.3);
      %\node(PI) [brownV, label=270:$I'$] at (3, 6.69){};
      %\draw[edgeDotted] (G) to (I);
      %\node(PT) [blackV, label=000:$T'$] at (8.5, 7.5){};
      %\draw[edgeDotted] (T) to (8.5,7.6);
      ...
      %\draw [line width=1pt, dash pattern=on 1pt off 2pt, black] (PT) circle(1);
...
\begin{frame}[fragile]{Algoritmo:}{Iteración 5.}
  ...
  \begin{figure}[ht!]
    ...
    \begin{tikzpicture}
      ...
      %\draw[line with = 0.5pt, dash pattern = on 1pt off 2pt]circle(0.655cm);
      % The built-in version for comparison
      \draw [line width=1pt, dash pattern=on 1pt off 2pt, black] (S) circle(1);
      %\draw [line width=1pt, dash pattern=on 1pt off 2pt, brown] (PI) circle(1);
      % Our version with automatically adapted pattern length
      %\draw [line width=1pt, cycled dash pattern=on 4pt off 4pt] (2,0) circle(0.655);
    \end{tikzpicture}
...
\begin{frame}[fragile]{Algoritmo:}{Iteración 5.}
  ...
  \begin{figure}[ht!]
    ...
    \begin{tikzpicture}
      ...
      \node(E) [blueV, label=270:$E$] at (2, 4){};
      %% Segundo bloque:
      \node(S) [greenV, label=0:$S$] at (1,10){};
      \node(F) [redV, label=180:$F$] at (2.18, 9){};
      \node(G) [redV, label=000:$G$] at (3, 9){};
      \node(H) [redV, label=180:$H$] at (2.18, 8){};
      \node(I) [redV, label=270:$I$] at (3, 8){};
