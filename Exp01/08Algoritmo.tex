...
\begin{frame}[fragile]{Algoritmo:}{Iteración 2.}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE 1
  \begin{figure}[ht!]
    \centering
    \begin{tikzpicture}
      ...
      %% Rectas:
      \draw[edge] (-1,4.3) to (10,4.3); % l_2
      \draw[edge] (-1,7.3) to (10,7.3); % l_1
      % Distancia d:
      \draw[edgeDottedL] (-0.4,4.3) to (-0.4,5.5); % distancia abajo.
      \draw[edgeDottedR] (-0.4,6) to (-0.4,7.3);   % distancia arriba.
      % Nombres:
      \node (L) at (-0.4,5.8){$d$};
      \node (L) at (10.3,4.3){$\ell_2$};
      \node (L) at (10.3,7.3){$\ell_1$};
...
\begin{frame}[fragile]{Algoritmo:}{Iteración 2.}
  ...
  \begin{figure}[ht!]
    ...
    \begin{tikzpicture}
      ...
      \node(I) [vertex, label=270:$I$] at (3, 8){};
      \node(J) [vertex, label=270:$J$] at (4, 8){};
      \node(K) [redV, label=270:$K$] at (4, 7){};
      \node(L) [redV, label=270:$L$] at (5, 7){};
      \node(M) [redV, label=270:$M$] at (4, 6){};
      \node(N) [redV, label=000:$N$] at (5, 6){};
      \node(O) [redV, label=270:$O$] at (5, 5){};
      \node(P) [redV, label=270:$P$] at (5, 4){};
